...
mesh = o3d.io.read_triangle_mesh('floor2.obj')

pcd = mesh.sample_points_poisson_disk(100000) # Sample points from the mesh
...
# o3d.visualization.draw_geometries([segments[i] for i in range(max_plane_idx)] + [rest], zoom=0.3199,
